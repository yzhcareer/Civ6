...
--UPDATE Units SET TraitType = "TRAIT_CIVILIZATION_UNIT_ENGLISH_SEADOG" WHERE UnitType = "UNIT_NUCLEAR_SUBMARINE";
--UPDATE Units SET TraitType = "TRAIT_CIVILIZATION_UNIT_AZTEC_EAGLE_WARRIOR" WHERE UnitType = "UNIT_HELICOPTOR";