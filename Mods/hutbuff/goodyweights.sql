...
UPDATE GlobalParameters SET Value = 5 WHERE Name = 'BARBARIAN_CAMP_MAX_PER_MAJOR_CITY';
UPDATE GlobalParameters SET Value = 5 WHERE Name = 'BARBARIAN_CAMP_MININUM_DISTANCE_ANOTHER_CAMP';
...
UPDATE GoodyHutSubTypes SET Weight = 60 WHERE SubTypeGoodyHut = 'GOODYHUT_ADD_POP';
