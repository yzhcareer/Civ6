...
VALUES
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_RECON', 10, 'GOODY_MILITARY_GRANT_RECON', 1, 1, 'LOC_GOODY_NULL_DESCRIPTION'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_RANGED', 10, 'GOODY_MILITARY_GRANT_RANGED', 1, 1, 'LOC_GOODY_NULL_DESCRIPTION'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_ANTI_CAVALRY', 10, 'GOODY_MILITARY_GRANT_ANTI_CAVALRY', 1, 1, 'LOC_GOODY_NULL_DESCRIPTION'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_HEAVY_CAVALRY', 20, 'GOODY_MILITARY_GRANT_HEAVY_CAVALRY', 1, 1, 'LOC_GOODY_GRANT_HEAVY_CAVALRY_UNIT_DESCRIPTION'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_LIGHT_CAVALRY', 20, 'GOODY_MILITARY_GRANT_LIGHT_CAVALRY', 1, 1, 'LOC_GOODY_GRANT_LIGHT_CAVALRY_UNIT_DESCRIPTION'),
    ('GOODYHUT_MILITARY', 'GOODYHUT_GRANT_SIEGE', 30, 'GOODY_MILITARY_GRANT_SIEGE', 1, 1, 'LOC_GOODY_GRANT_SIEGE_UNIT_DESCRIPTION');
